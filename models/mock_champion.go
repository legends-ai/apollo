...
type MockChampionDAO struct{}

// Get gets a champion.
func (dao *MockChampionDAO) Get(ctx context.Context, req *apb.GetChampionRequest) (*apb.Champion, error) {
...
func (c *MockChampionDAO) GetMatchup(ctx context.Context, req *apb.GetMatchupRequest) (*apb.Matchup, error) {
